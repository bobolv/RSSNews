...
**to monitor progress**in the GitHub Mobile app or web.**Steer the session**with follow-up instructions.**Review the implementation plan**and proposed changes.**Create and review a pull request**, right from your phone.**Merge**and move on.
